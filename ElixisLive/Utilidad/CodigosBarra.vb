...
Public Class CodigosBarra
    Public Shared Function codigo128(ByVal codigo As String, Optional ByVal vertexto As Boolean = False, Optional ByVal Tamaño As Single = 0)
        Dim barcode As New BarcodeCodabar
        barcode.StartStopText = True
        If Tamaño <> 0 Then
            barcode.BarHeight = Tamaño
        End If
        barcode.Code = codigo
        Try
