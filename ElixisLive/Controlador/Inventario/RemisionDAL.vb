...
Public Class RemisionDAL
    Public Shared Function guardarVenta(objVenta As RemisionInventario) As RemisionInventario
        ...
        Try
            ...
            Using comando = New SqlCommand()
                Using trnsccion = objConexio.cnxbd.BeginTransaction()
                    ...
                    comando.Parameters.Add(New SqlParameter("@Observacion", SqlDbType.NVarChar)).Value = objVenta.observacion
