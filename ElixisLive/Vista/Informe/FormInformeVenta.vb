Public Class FormInformeVenta
    ...
    End Sub
    Private Sub TextTelefono_Validating(sender As Object, e As EventArgs) 
        ...
        End If
    End Sub
    Private Sub TextIdentificacion_Validating(sender As Object, e As EventArgs) 
        ...
        End If
    End Sub
    Private Sub TextNombre_Validating(sender As Object, e As EventArgs) 
        ...
        End If
    End Sub
    Private Sub txtNumeroFatura_Validating(sender As Object, e As EventArgs) 
        ...
        End If
    End Sub
    Private Sub txtNumeroFatura_Leave(sender As Object, e As EventArgs) 
        dgvFactura.Focus()
    End Sub
    Private Sub txtNumeroFatura_KeyPress(sender As Object, e As KeyPressEventArgs) 
        If Asc(e.KeyChar) = 13 Then
            dgvFactura.Focus()
        End If
    End Sub

    Private Sub TextTelefono_KeyPress(sender As Object, e As KeyPressEventArgs) 
        ValidacionDigitacion.validarNumerosTelefono(e)
        If Asc(e.KeyChar) = 13 Then
            txtNumeroFatura.Focus()
        End If
    End Sub
    Private Sub TextNombre_KeyPress(sender As Object, e As KeyPressEventArgs) 
