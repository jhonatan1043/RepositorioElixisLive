Public Class FormCliente
    ...
    Private Sub cargarInfomacion(pcodigo As Integer)
        ...
        objCliente.codigo = pcodigo
        params.Add(objCliente.codigo)
    ...
    Private Sub btBuscar_Click(sender As Object, e As EventArgs) Handles btBuscar.Click
        ...
        params.Add(SesionActual.idEmpresa)
        Try
            Generales.buscarElemento(objCliente.sqlConsulta,
                                   params,
    ...
    Private Function validarCampos() As Boolean
        ...
        If IsNothing(objCliente.codigo) Then
    ...
    Private Sub btAnular_Click(sender As Object, e As EventArgs) Handles btAnular.Click
        If EstiloMensajes.mostrarMensajePregunta(MensajeSistema.ANULAR) = Constantes.SI Then
            Try
                If Generales.ejecutarSQL(objCliente.sqlAnular & objCliente.codigo) = True Then
                    Generales.limpiarControles(Me)
                    Generales.deshabilitarBotones(ToolStrip1)
                    btNuevo.Enabled = True
